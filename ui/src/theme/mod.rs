...
impl Theme {
    ...
    pub fn apply_to_ctx(&self, ctx: &eframe::egui::Context) {
        use eframe::egui::{Style, Visuals, Rounding, Stroke};
        ...
        visuals.faint_bg_color = self.list_hover;
        
        // Text colors
        visuals.override_text_color = Some(self.fg);
        
        // Widget styling
        visuals.widgets.noninteractive.bg_fill = self.sidebar_bg;
        visuals.widgets.noninteractive.fg_stroke = Stroke::new(1.0, self.fg_dim);
        visuals.widgets.noninteractive.rounding = Rounding::same(4.0);
        
        visuals.widgets.inactive.bg_fill = self.input_bg;
        visuals.widgets.inactive.fg_stroke = Stroke::new(1.0, self.fg);
        
        visuals.widgets.hovered.bg_fill = self.list_hover;
        visuals.widgets.hovered.fg_stroke = Stroke::new(1.0, self.fg_bright);
        
        visuals.widgets.active.bg_fill = self.accent;
        visuals.widgets.active.fg_stroke = Stroke::new(1.0, self.selected_fg);
